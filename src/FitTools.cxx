...
#define MAX_R 1e10
{
  ...
  if ( _fitModel == PLAN_WAVE )
  {
    ...
    //===
    _xPORT.B( 1, 1 ) = 0.0*M_PI/180;    // theta parameter (1st) min value (1) is 0.0
  ...
  else if (_fitModel == SPHERE_WAVE)
  {
    ...
    _xPORT.B( 1, 1 ) = 0;  // theta parameter (1st) min value (1)
    _xPORT.B( 2, 1 ) = M_PI;  // theta parameter (1st) max value (2)
    _xPORT.B( 1, 2 ) = 0;    // phi parameter (2nd) min value (1)
    _xPORT.B( 2, 2 ) = 2*M_PI;    // phi parameter (2nd) max value (2)
    _xPORT.B( 1, 3) = 500;    // r parameter (3th) min value (1)
    _xPORT.B( 2, 3) = 20000;     // r parameter (3th) max value (2)
    _xPORT.B( 1, 4) = -20000;  // t parameter (3th) max value (2) similar to r !
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
{
  ...
  double GroundAltitude = 1205.;//1086.;
